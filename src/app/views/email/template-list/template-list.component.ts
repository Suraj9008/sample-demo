...
export class TemplateListComponent implements OnInit {
  ...
  displayedColumns = ['id', 'templateName', 'catagaryType', 'moduleHeading','operation'];
...
function createNewUser(id: number): UserData {
  ...
  return {
    ...
    catagaryType:Address[Math.round(Math.random() * (Address.length - 1))],
    moduleHeading:workDetails[Math.round(Math.random() * (workDetails.length - 1))],
